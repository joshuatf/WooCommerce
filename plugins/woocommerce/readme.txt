...
* Fix - Mini Cart - Avoid error when adding products without a description.
...
* Dev - Migrate the product summary block to fetch product data via the `@wordpress/core-data` package.
...
* Enhancement - Fixed scroll position issue by ensuring the Offline Gateways page always loads at the top.
