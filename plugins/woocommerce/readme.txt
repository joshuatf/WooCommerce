...
* Fix - Fix an issue when a product is not an object in html order item [#60215](https://github.com/woocommerce/woocommerce/pull/60215)
...
* Fix - Preserve manual discount when manually editing an order [#60240](https://github.com/woocommerce/woocommerce/pull/60240)
...
* Fix - Test changelog entry
* Fix - Updated OrderCountCache to return values for all previously saved statuses, not just those registered. [#60209](https://github.com/woocommerce/woocommerce/pull/60209)
* Fix - Use dynamically-generated URLs for resetting accounts and switching to live accounts in the Payments NOX. [#60192](https://github.com/woocommerce/woocommerce/pull/60192)
...
* Enhancement - Set the ‘Set up payments’ task to in-progress state upon starting live WooPayments onboarding. [#60162](https://github.com/woocommerce/woocommerce/pull/60162)
